...
pub enum TexturePixelFormat {
    ...
    SignedDistanceField,
    /// Subpixel (LCD) rendering. 32bits BGRA with separate alpha per subpixel.
    /// Used for high-quality text rendering on LCD screens.
    SubpixelMap,
}
...
impl TexturePixelFormat {
    ...
    pub fn bpp(self) -> usize {
        match self {
            ...
            TexturePixelFormat::SubpixelMap => 4,
        }
    }
}
                    ...
                    for y in 0..rect.height() {
                        ...
                        match t.format {
                            ...
                            TexturePixelFormat::SubpixelMap => {
                                todo!("converting from a subpixel map to an image")
                            }
                        };
                    }
                }
